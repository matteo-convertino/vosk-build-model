[![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2Fmatteo-39%2Fvosk-build-model&count_bg=%231F77DA&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=Visite&edge_flat=false)](#)
...
- Potrebbe capitare che l'addestramento si blocchi durante le iterazioni senza un errore e se si prova ad eseguire `nvidia-smi` anch'esso si bloccherà. Per risolvere questo bug bisogna eseguire `sudo nvidia-smi -pm 1` prima di far partire l'addestramento.
